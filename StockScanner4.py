...
class HomeWindow:
    ...
    def start_scanning(self):
        ...
        stock_symbols = ["BNGO", "LDTC", "TNXP", "TSLA", "MLGO", "VRAX", "NVDA", "NFLX", "SPY", "QQQ"]
    ...
    def show_results(self):
        ...
        stock_symbols = ['TNXP', 'BNGO', 'LDTC', 'VRAX', 'MLGO']
        stock_predictor = StockPredictor()
        ...
        for stock_symbol in stock_symbols:
            ...
            if stock_data is not None and not stock_data.empty:
                try:
                    ...
                    self.plot_stock_data(stock_data, scrollable_frame)
    ...
    def plot_stock_data(self, stock_data, parent_frame):
        fig, ax1 = plt.subplots()

        ax1.set_title("Stock Price with Indicators")
        ax1.set_xlabel("Date")
        ...
        ax1.plot(stock_data.index, stock_data["SMA"], label="SMA (20)")

        stock_data["RSI"] = self.stock_predictor.compute_rsi(stock_data["Close"])
        ax2.plot(stock_data.index, stock_data["RSI"], label="RSI (14)", color="tab:red")
